...
<head>
    ...
    <title>Filme Jack Box - Neoxtv</title>
</head>
<body class="dark_background">
  ...
  <br><br><br><br><br>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="abount-img">
                        <img src="../../img/jackBox_terror.jpg" alt="" class="img-fluid rounded" id="tam">
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
                    <div class="about-text">
                        <h2>Jack in the box awakening 2</h2>
                        <h4>2022 / Terror </h4>
                        <h4>Classificação etária 18 anos </h4>
                        <p>Quando uma mulher moribunda abre uma antiga caixa misteriosa, 
                        ela entra em um acordo com o demônio dentro dela que curaria sua 
                        doença em troca de ajudá-lo a reclamar seis vítimas inocentes.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="video">
            <iframe width="1000" height="600" src="https://www.youtube.com/embed/3pIKzYXqmI4" 
            title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; 
            encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

            <h5>Video produzido por A2 Filmes </h5>
        </div>
      </div>
