...
<head>
    ...
    <title>Filme Avatar: O Caminho da Água - Neoxtv</title>
</head>
<body class="dark_background">
  ...
  <br><br><br><br><br>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="abount-img">
                        <img src="../../img/avatar_acao.jpg" alt="" class="img-fluid rounded" id="tam">
                    </div>
                </div>
      ...
      <div class="container">
        ...
        <div class="video">
        <iframe width="1000" height="600" src="https://www.youtube.com/embed/rLhhJQysKLk" 
