...
<head>
    ...
    <title>Filme Halloween Ends - Neoxtv</title>
</head>
<body class="dark_background">
  ...
  <br><br><br><br><br>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="abount-img">
                        <img src="../../img/halloweenEnds.jpg" alt="" class="img-fluid rounded" id="tam">
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
                    <div class="about-text">
                        ...
                        <p>Depois de seu último encontro com Michael Myers, Laurie Strode finalmente 
                        decide se libertar e abraçar a vida. No entanto, um assassinato local desencadeia 
                        uma onda de violência e terror, forçando-a a enfrentar o mal que ela não pode controlar.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="video">
        <iframe width="1000" height="600" src="https://www.youtube.com/embed/gz1-ixdPGhM" 
