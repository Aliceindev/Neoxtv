...
<head>
    ...
    <title>Filme Terrifier 2 - Neoxtv</title>
</head>
<body class="dark_background">
  ...
  <br><br><br><br><br>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="abount-img">
                        <img src="../../img/terrifier2.jpg" alt="" class="img-fluid rounded" id="tam">
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
                    <div class="about-text">
                        ...
                        <p>Após ser ressuscitado por uma entidade sinistra, Art, o Palhaço, retorna ao Condado de Miles,
                         onde irá à caça de uma adolescente e seu irmão mais novo na noite de Halloween.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="video">
        <iframe width="1000" height="600" src="https://www.youtube.com/embed/6KkONLf_ZKU" 
        title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; 
        clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

            <h5>Video produzido por Cinedigm</h5>
        </div>
      </div>
